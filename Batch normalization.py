...
#%%Get Model
def get_model(batch_normalization, kernel_size=(3,3), pool_size=(4,4), first_filters=32, second_filters=64, conv=False):
...
#Batch normalization
model1 = get_model(batch_normalization=True)
model_training(model1, train_gen, val_gen, 'Model_1')
ROC_analysis(model1, val_gen)

#No normalization
model2 = get_model(batch_normalization=False)
